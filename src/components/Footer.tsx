...
const footerLinks = [
  ...navLinks.filter((link) => ["#story", "#villas", "#experiences", "#gallery"].includes(link.href)),
  ...
  return (
    <footer className="relative overflow-hidden bg-deep-charcoal text-warm-white">
      ...
      <div className="container-lux relative py-16 md:py-20 lg:py-24">
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between lg:gap-16">
            <div className="max-w-xl">
              ...
              <p className="mt-5 max-w-md text-sm font-light leading-relaxed text-warm-white/58 md:text-[0.95rem]">
                Four chakra-inspired chalets in a secret Dambulla garden — privacy, wellness, and unhurried hospitality.
              </p>
            </div>
        ...
        <div className="mt-8 flex flex-col gap-2 px-1 text-[0.7rem] text-warm-white/38 sm:mt-10 sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {year} {brand.name}
          </p>
